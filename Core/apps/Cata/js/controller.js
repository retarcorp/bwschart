	...
	,Actions:{
		...
		,Elements:{
			...
			List:{
				...
				,refresh: function(){
				    _.new("div").get("modules/catalogList.php",{},function(r){
				        try{
				            var d = JSON.parse(r);
				            _.$(".list").fromTemplate("catalog",d);
				            Application.Actions.Elements.List.init(r);
				        }catch(e){
