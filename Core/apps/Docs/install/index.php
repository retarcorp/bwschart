<?php
	...
	if(mysql_error()){
		Logger::addReport("info",Logger::STATUS_ERROR,"Не удалось удалить таблицу cata_manual для установки справочной системы! Ошибка на уровне SQL: ".mysql_error());
		die();
	}else{
	...
	if(mysql_error()){
		Logger::addReport("info",Logger::STATUS_ERROR,"Не удалось создать таблицу cata_manual для установки справочной системы! Ошибка на уровне SQL: ".mysql_error());
		die();
	}else{
