Test = {
    ...
    getdata: function(i, j) {
        ...
        } else this.send(this.candlesHoles);
    },
    ...
    show: function(res, f) {
        ...
        if (data.length) this.candlesHoles.push(data);
    ...
    send: function(data){
        ...
        _.postJSON('/HolesRemover/receiver.php', {data: JSON.stringify(data) }, (data) => console.log(data) );
    }
};
