var Ui = {
    ...
    updateVisualSettings: function() {
        ...
        console.log('update', App.deltaVisualSettings.DIR_PLUS, Ui.visualSettingsBtns.colorPlusDelta.value);
    },
    ...
    setVisualSettingsColor: function(){
        try{
            ...
            if (currentDeltaVisualSettings && currentFootprintVisualSettings) {
